 ...
 * @version   3.19.0-canary+6e4deec2
 */
...
define("@glimmer/compiler", ["exports", "ember-babel", "node-module", "@glimmer/util", "@glimmer/wire-format", "@glimmer/syntax"], function (_exports, _emberBabel, _nodeModule, _util, _wireFormat, _syntax) {
  ...
  function () {
    function LocalSymbols(parent, locals) {
      ...
      for (var _iterator = locals, _isArray = Array.isArray(_iterator), _i2 = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref;
      ...
      :
        {
          return [[1
          /* Append */
          , +normalized.trusted, buildPath(normalized.path, 0
          /* AppendSingleId */
          , symbols)]];
        }
      ...
      :
        {
          return [[1
          /* Append */
          , +normalized.trusted, buildExpression(normalized.expr, 1
          /* Expression */
          , symbols)]];
        }
  ...
  function buildVar(head, context, symbols, path) {
    ...
    return path === undefined ? [op, sym] : [op, sym, path];
  }
  ...
  function () {
    ...
    _proto12.block = function block(_ref3) {
      var template = _ref3[0],
          inverse = _ref3[1];
    ...
    _proto12.openElement = function openElement(_ref4) {
      var element = _ref4[0],
          simple = _ref4[1];
      var tag = element.tag;
    ...
    _proto12.staticAttr = function staticAttr(_ref5) {
      var name = _ref5[0],
          namespace = _ref5[1];
    ...
    _proto12.staticComponentAttr = function staticComponentAttr(_ref6) {
      var name = _ref6[0],
          namespace = _ref6[1];
      var value = this.popValue();
      this.push([23
    ...
    _proto12.dynamicAttr = function dynamicAttr(_ref7) {
      var name = _ref7[0],
          namespace = _ref7[1];
      var value = this.popValue();
      this.push([13
    ...
    _proto12.componentAttr = function componentAttr(_ref8) {
      var name = _ref8[0],
          namespace = _ref8[1];
      var value = this.popValue();
      this.push([14
    ...
    _proto12.trustingAttr = function trustingAttr(_ref9) {
      var name = _ref9[0],
          namespace = _ref9[1];
      var value = this.popValue();
      this.push([20
    ...
    _proto12.trustingComponentAttr = function trustingComponentAttr(_ref10) {
      var name = _ref10[0],
          namespace = _ref10[1];
      var value = this.popValue();
      this.push([21
    ...
    _proto12.getFreeWithContext = function getFreeWithContext(_ref11) {
      var head = _ref11[0],
          context = _ref11[1];
  ...
  function () {
    ...
    _proto13.getVar = function getVar(_ref12) {
      var name = _ref12[0],
          context = _ref12[1];
    ...
    _proto13.block = function block(_ref13) {
      var template = _ref13[0],
          inverse = _ref13[1];
    ...
    _proto13.openElement = function openElement(_ref14) {
      var element = _ref14[0],
          simple = _ref14[1];
    ...
    _proto13.staticAttr = function staticAttr(_ref15) {
      var name = _ref15[0],
          ns = _ref15[1];
      return ['staticAttr', [name, ns]];
    };

    _proto13.staticComponentAttr = function staticComponentAttr(_ref16) {
      var name = _ref16[0],
          ns = _ref16[1];
      return ['staticComponentAttr', [name, ns]];
    };

    _proto13.trustingAttr = function trustingAttr(_ref17) {
      var name = _ref17[0],
          ns = _ref17[1];
      return ['trustingAttr', [name, ns]];
    };

    _proto13.dynamicAttr = function dynamicAttr(_ref18) {
      var name = _ref18[0],
          ns = _ref18[1];
      return ['dynamicAttr', [name, ns]];
    };

    _proto13.componentAttr = function componentAttr(_ref19) {
      var name = _ref19[0],
          ns = _ref19[1];
      return ['componentAttr', [name, ns]];
    };

    _proto13.trustingComponentAttr = function trustingComponentAttr(_ref20) {
      var name = _ref20[0],
          ns = _ref20[1];
  ...
  function () {
    ...
    _proto14.process = function process(actions) {
      ...
      actions.forEach(function (_ref21) {
        var name = _ref21[0],
            args = _ref21[1];
    ...
    _proto14.startProgram = function startProgram(_ref22) {
    ...
    _proto14.startBlock = function startBlock(_ref23) {
      var program = _ref23[0];
      this.templateId++;
    ...
    _proto14.text = function text(_ref24) {
      var action = _ref24[0];
      this.opcode(['text', action.chars], action);
    };

    _proto14.comment = function comment(_ref25) {
      var action = _ref25[0];
      this.opcode(['comment', action.value], action);
    };

    _proto14.openElement = function openElement(_ref26) {
      var action = _ref26[0];
      ...
      if (!isNamedBlock(action)) {
        ...
        for (var _i3 = 0; _i3 < attrs.length; _i3++) {
          if (attrs[_i3].name === 'type') {
            typeAttr = attrs[_i3];
            continue;
          }

          this.attribute([attrs[_i3]], !simple || actionIsComponent);
        }
        ...
        for (var _i4 = 0; _i4 < action.modifiers.length; _i4++) {
          this.modifier([action.modifiers[_i4]]);
        }
    ...
    _proto14.closeElement = function closeElement(_ref27) {
      var action = _ref27[0];
    ...
    _proto14.attribute = function attribute(_ref28, isComponent) {
      var action = _ref28[0];
    ...
    _proto14.modifier = function modifier(_ref29) {
      var action = _ref29[0];
    ...
    _proto14.mustache = function mustache(_ref30) {
      var _mustache = _ref30[0];
    ...
    _proto14.block = function block(_ref31) {
      var action
      /*, index, count*/
      = _ref31[0];
  ...
  function isSimplePath(_ref32) {
    var parts = _ref32.parts;
...
define("@glimmer/wire-format", ["exports"], function (_exports) {
  ...
  function isHelper(expr) {
    return Array.isArray(expr) && expr[0] === 27
    /* Call */
    ;
  } // Expressions
...
define("ember-template-compiler/lib/plugins/index", ["exports", "ember-template-compiler/lib/plugins/assert-against-named-blocks", "ember-template-compiler/lib/plugins/assert-if-helper-without-arguments", "ember-template-compiler/lib/plugins/assert-input-helper-without-block", "ember-template-compiler/lib/plugins/assert-local-variable-shadowing-helper-invocation", "ember-template-compiler/lib/plugins/assert-reserved-named-arguments", "ember-template-compiler/lib/plugins/assert-splattribute-expression", "ember-template-compiler/lib/plugins/deprecate-send-action", "ember-template-compiler/lib/plugins/transform-action-syntax", "ember-template-compiler/lib/plugins/transform-attrs-into-args", "ember-template-compiler/lib/plugins/transform-component-invocation", "ember-template-compiler/lib/plugins/transform-each-in-into-each", "ember-template-compiler/lib/plugins/transform-each-track-array", "ember-template-compiler/lib/plugins/transform-has-block-syntax", "ember-template-compiler/lib/plugins/transform-in-element", "ember-template-compiler/lib/plugins/transform-link-to", "ember-template-compiler/lib/plugins/transform-old-class-binding-syntax", "ember-template-compiler/lib/plugins/transform-quoted-bindings-into-just-bindings", "ember-template-compiler/lib/plugins/transform-wrap-mount-and-outlet", "@ember/canary-features", "@ember/deprecated-features"], function (_exports, _assertAgainstNamedBlocks, _assertIfHelperWithoutArguments, _assertInputHelperWithoutBlock, _assertLocalVariableShadowingHelperInvocation, _assertReservedNamedArguments, _assertSplattributeExpression, _deprecateSendAction, _transformActionSyntax, _transformAttrsIntoArgs, _transformComponentInvocation, _transformEachInIntoEach, _transformEachTrackArray, _transformHasBlockSyntax, _transformInElement, _transformLinkTo, _transformOldClassBindingSyntax, _transformQuotedBindingsIntoJustBindings, _transformWrapMountAndOutlet, _canaryFeatures, _deprecatedFeatures) {
  "use strict";
  ...
  if (!_canaryFeatures.EMBER_NAMED_BLOCKS) {
...
define("ember/version", ["exports"], function (_exports) {
  ...
  _exports.default = void 0;
  var _default = "3.19.0-canary+6e4deec2";
  _exports.default = _default;
});
